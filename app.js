...
async function inspectSources(paths){
  for(const path of paths){
    ...
    catch(e){state.sources.push({path,info:{locations:[]},error:e.message});}
  }
  render();
}
function render(){
